                            ...
                            <form className="">
                                <div className="input-group mb-3">
                                    <div className="input-group-prepend">
                                        <button className="btn btn-outline-secondary light-grey fas fa-long-arrow-alt-left" style={{fontSize: 17}} type="button"></button>
                                    </div>
                                    <input type="text" className="form-control sign-up rtl" placeholder="اشترك معنا" aria-label="" aria-describedby="basic-addon1" />
                                </div>
                            </form>
